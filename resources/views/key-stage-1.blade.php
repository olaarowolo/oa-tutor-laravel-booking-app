...
<section class="px-5 py-5 mx-auto flex flex-wrap items-center justify-center" id="ks1">
      <main class="max-w-4xl w-full">
        <section class="mb-8">
          ...
          <p>At tutor.olaarowolo.com, I provide personalised Maths and English tuition designed to help your child make
        ...
        <section class="mb-8">
          ...
          <ul class="list-disc pl-6 space-y-2">
            <li><b>Core Maths and English Skills:</b> Tailored for children aged 4-14, my lessons are aligned with the
              school curriculum in England, Scotland, and Wales.</li>
            <li><b>Personalised Curriculum:</b> I adapt the curriculum to meet your child&#39;s specific needs, ensuring
              they receive the appropriate level of support and challenge.</li>
            <li><b>Flexible Learning:</b> Your child has 24/7 access to smart learning tools, allowing them to learn at
        ...
        <section class="mb-8">
          ...
          <ul class="list-disc pl-6 space-y-2">
            <li><b>Maths:</b> From basic addition to advanced topics like algebra, I cover all essential areas to build
            ...
            <li><b>Phonics:</b> I help younger learners develop early reading skills with confidence and fluency.</li>
            <li><b>SATs Preparation:</b> I offer focused support to help your child excel in key exams, ensuring they
        ...
        <section class="mb-8">
          ...
          <ul class="list-disc pl-6 space-y-2">
            <li><b>Qualified and Experienced: </b> I hold high academic qualifications, including a BSc, an MSc, and a
              PhD, with over 7 years of international teaching experience across primary, secondary, and university
              levels.</li>
            <li><b>Safe and Trustworthy:</b> I am fully DBS checked, providing you with peace of mind.</li>
            <li><b>Dedicated Support:</b> I work closely with each student, building their confidence and fostering a
